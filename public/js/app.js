...
var options = {
  ...
  methods: {
    templateTest: function templateTest() {
      return "<div class=\"card\"><div class=\"card-body\">".concat(this.title, "\n            <p><i>").concat(this.description, "</i></p>\n            </div>\n            </div>\n            ");
    },
    ...
    countChar: function countChar(keyup) {
  ...
  created: function created() {
    ...
    setTimeout(function () {
      ...
      _this.toggleClass = "bg-info text-dark";
    }, 3000);
  }
};
